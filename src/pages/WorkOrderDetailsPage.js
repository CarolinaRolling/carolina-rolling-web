        ...
        {isEditing ? (
          ...
          <>
            <div className="detail-grid">
              ...
              {order.contactName && <div className="detail-item"><div className="detail-item-label">Contact Name</div><div className="detail-item-value">{order.contactName}{order.contactExtension ? <span style={{ color: '#888', marginLeft: 6, fontSize: '0.85rem' }}>x{order.contactExtension}</span> : null}</div></div>}
