    ...
    <div>
                        ...
                        <div>
                          ...
                          <div style={{ display: 'flex', gap: 8, marginTop: 10 }}>
                            <button className="btn btn-primary" disabled={wsBusy} onClick={async () => {
                              setWsBusy(true);
                              try {
                                const res = await submitPricingWorksheet(pricingTab, wsAnswers, worksheet.rows);
      ...
      {activeTab === 'emailscanner' && !loading && (
        <div>
          ...
          <div className="card" style={{ marginBottom: 20 }}>
            <h3 style={{ marginTop: 0, marginBottom: 4 }}>🤖 AI Models <span style={{ fontSize: '0.65rem', fontWeight: 400, color: '#90a4ae', marginLeft: 6 }}>UI build v293</span></h3>
