...
export const getWorkOrderMessagesUnreadList = () => api.get('/workorders/messages/unread');
export const markWorkOrderMessagesRead = (id) => api.post(`/workorders/${id}/messages/mark-read`);
...
export const convertEstimateToWorkOrder = (estimateId, data) => api.post(`/estimates/${estimateId}/convert-to-workorder`, data, { timeout: 120000 });
...
export const getFrequentDrivers = (id) => api.get(`/workorders/${id}/frequent-drivers`);
...
export const markInvoicesEntered = (workOrderIds) => api.post('/quickbooks/mark-entered', { workOrderIds });
export const unmarkInvoicesEntered = (workOrderIds) => api.post('/quickbooks/unmark-entered', { workOrderIds });
...
export const sendInvoiceEmail = (id, data) => api.post(`/quickbooks/invoice-email/${id}`, data);
export const updateInvoiceNumber = (id, invoiceNumber, confirmReuseExported = false) => api.put(`/quickbooks/invoice-number/${id}`, { invoiceNumber, ...(confirmReuseExported ? { confirmReuseExported: true } : {}) });
export const getInvoiceSends = (id) => api.get(`/quickbooks/invoice-sends/${id}`);
export const logInvoiceSend = (id, data) => api.post(`/quickbooks/invoice-sends/${id}`, data);
...
export const scanDraftPricing = () => api.post('/email-scanner/scan-draft-pricing');
...
export const dismissAllInboundPaperwork = () => api.post('/inbound-paperwork/dismiss-all', {});
export const convertPaperworkToEstimate = (id, clientId) => api.post(`/inbound-paperwork/${id}/convert-to-estimate`, clientId ? { clientId } : {});
export const convertPaperworkToOrder = (id, clientId) => api.post(`/inbound-paperwork/${id}/convert-to-order`, clientId ? { clientId } : {});
export const clearPaperworkDockReceive = (id) => api.post(`/inbound-paperwork/${id}/clear-dock-receive`, {});
...
export const getCommBills = () => api.get('/com-center/bills');
export const updateBillStatus = (id, status) => api.patch(`/com-center/bills/${id}/status`, { status });
export const scanCommBills = () => api.post('/com-center/bills/scan');
...
export const getInspectionTools = () => api.get('/inspections/tools');
export const createInspectionTool = (data) => api.post('/inspections/tools', data);
export const updateInspectionTool = (id, data) => api.patch(`/inspections/tools/${id}`, data);
export const deleteInspectionTool = (id) => api.delete(`/inspections/tools/${id}`);
...
// Pricing calibration worksheet + AI usage panel
...
export const getAiUsage = () => api.get('/settings/ai-usage');
