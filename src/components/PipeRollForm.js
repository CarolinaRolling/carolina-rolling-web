  ...
  return (
    <>
      ...
      <div style={sectionStyle}>
        ...
        {/* Centerline calc display */}
        {rollCalc && (
          <div style={{ background: '#f3e5f5', padding: 10, borderRadius: 6, marginTop: 8, fontSize: '0.85rem' }}>
            Centerline Diameter: <strong>{rollCalc.centerlineDia.toFixed(2)}"</strong>
          </div>
        )}
