...
// Extra per-part tracking fields (Client Job #, Rev, PO Line #, Lot #).
  ...
  return (
    <>
      <div className="form-group">
        ...
        <input type="text" className="form-input" value={partData.clientJobNumber || ''} onChange={(e) => set('clientJobNumber', e.target.value)} placeholder="Optional" />
      </div>
      <div className="form-group">
