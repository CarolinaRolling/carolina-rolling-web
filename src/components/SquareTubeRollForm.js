  ...
  useEffect(() => {
    if (completeRings && ringCalc && !ringCalc.error) {
      ...
      setPartData(prev => ({
        ...
        _ringMultiSegment: ringCalc.multiSegment || false, _ringCutLengthPerRing: ringCalc.cutLengthPerRing || 0, _ringOverlap: cutServiceType === 'cut_to_ring_overlap' ? (parseFloat(ringOverlap) || 0) : 0,
